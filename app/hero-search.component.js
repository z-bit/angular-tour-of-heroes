...
var HeroSearchComponent = (function () {
    ...
    HeroSearchComponent.prototype.searchHero = function (term) {
    ...
    HeroSearchComponent.prototype.ngOnInit = function () {
        ...
        this.heroes = this.searchTerms
            ...
            .switchMap(function (term) { return term // switch to new obsevable each time
            ? _this.heroSearchService.search(term) // http search obsevable
            : Observable_1.Observable.of([]); } // observable of empty heroes
        )
